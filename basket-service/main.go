...
import (
	basket2 "github.com/eneskzlcn/pact-cdc/basket-service/app/basket"
	"github.com/eneskzlcn/pact-cdc/basket-service/app/persistence"
	"github.com/eneskzlcn/pact-cdc/basket-service/app/product"
	"github.com/eneskzlcn/pact-cdc/basket-service/app/stock"
	"github.com/eneskzlcn/pact-cdc/basket-service/config"
...
func main() {
	...
	basketService := basket2.NewService(&basket2.NewServiceOpts{
		R: repository, L: logger, PC: productClient, SC: stockClient,
	})

	basketHandler := basket2.NewHandler(&basket2.NewHandlerOpts{
